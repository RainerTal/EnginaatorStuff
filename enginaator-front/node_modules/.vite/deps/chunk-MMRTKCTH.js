...
var getAnchorId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.anchor) ?? `popover:${scope.id}:anchor`;
};
var getTriggerId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.trigger) ?? `popover:${scope.id}:trigger`;
};
var getContentId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.content) ?? `popover:${scope.id}:content`;
};
var getPositionerId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.positioner) ?? `popover:${scope.id}:popper`;
};
var getArrowId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.arrow) ?? `popover:${scope.id}:arrow`;
};
var getTitleId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.title) ?? `popover:${scope.id}:title`;
};
var getDescriptionId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.description) ?? `popover:${scope.id}:desc`;
};
var getCloseTriggerId = (scope) => {
  var _a;
  return ((_a = scope.ids) == null ? void 0 : _a.closeTrigger) ?? `popover:${scope.id}:close`;
};
  ...
  implementations: {
    ...
    actions: {
      ...
      setFinalFocus({ event, scope }) {
        var _a;
        const restoreFocus = event.restoreFocus ?? ((_a = event.previousEvent) == null ? void 0 : _a.restoreFocus);
...
//# sourceMappingURL=chunk-MMRTKCTH.js.map
