...
var getHiddenInputId = (ctx, index) => {
  var _a, _b;
  return ((_b = (_a = ctx.ids) == null ? void 0 : _a.hiddenInput) == null ? void 0 : _b.call(_a, index)) ?? `slider:${ctx.id}:input:${index}`;
};
...
var getValueTextId = (ctx) => {
  var _a;
  return ((_a = ctx.ids) == null ? void 0 : _a.valueText) ?? `slider:${ctx.id}:value-text`;
};
...
function connect(service, normalize2) {
  ...
  return {
    ...
    getLabelProps() {
      return normalize2.label({
        ...
        onClick(event) {
          ...
          (_a = getFirstThumbEl(scope)) == null ? void 0 : _a.focus();
        },
        style: {
          userSelect: "none",
          WebkitUserSelect: "none"
    ...
    getThumbProps(props2) {
      ...
      const valueText = (_a = prop("getAriaValueText")) == null ? void 0 : _a({ value, index });
    ...
    return {
      ...
      focusedIndex: bindable(() => ({
        ...
        onChange(value) {
          ...
          (_a = prop("onFocusChange")) == null ? void 0 : _a({ focusedIndex: value, value: ctx.get("value") });
        }
      })),
  ...
  implementations: {
    ...
    actions: {
      ...
      invokeOnChangeEnd({ prop, context }) {
        var _a;
        (_a = prop("onValueChangeEnd")) == null ? void 0 : _a({ value: context.get("value") });
      },
...
//# sourceMappingURL=chunk-SZPDR2YD.js.map
