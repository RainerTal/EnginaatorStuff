...
var getItemId = (ctx, id) => {
  var _a, _b;
  return ((_b = (_a = ctx.ids) == null ? void 0 : _a.item) == null ? void 0 : _b.call(_a, id)) ?? `rating:${ctx.id}:item:${id}`;
};
  ...
  context({ prop, bindable }) {
    return {
      ...
      hoveredValue: bindable(() => ({
        ...
        onChange(value) {
          var _a;
          (_a = prop("onHoverChange")) == null ? void 0 : _a({ hoveredValue: value });
        }
      })),
  ...
  implementations: {
    guards: {
      ...
      isRadioFocused: ({ scope }) => {
        var _a;
        return !!((_a = getControlEl(scope)) == null ? void 0 : _a.contains(scope.getActiveElement()));
      }
    },
    effects: {
    ...
    actions: {
      ...
      focusActiveRadio({ scope, context }) {
        raf(() => {
          var _a;
          return (_a = getRadioEl(scope, context.get("value"))) == null ? void 0 : _a.focus();
        });
      },
...
//# sourceMappingURL=chunk-3N7WVU5B.js.map
